...
const TITLE = "Padel Matchup — Toernooibeheer";
const DESC =
  "Beheer padeltoernooien van begin tot eind: poulefase, Americano-rotaties, knock-outschema's, live standen, groot-schermmodus en Excel-export.";
...
export const Route = createFileRoute("/nl")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: SITE + "/nl" },
...
function DutchPage() {
  return (
    <>
      ...
      />
      <PadelTournament initialLang="nl" />
    </>
  );
}
