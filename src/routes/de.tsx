...
const TITLE = "Padel Matchup — Turnierverwaltung";
const DESC =
  "Organisiere Padel-Turniere von Anfang bis Ende: Gruppenphase, Americano-Rotationen, K.o.-Runden, Live-Tabellen, Großbildschirm-Modus und Excel-Export.";
...
export const Route = createFileRoute("/de")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: SITE + "/de" },
...
function GermanPage() {
  return (
    <>
      ...
      />
      <PadelTournament initialLang="de" />
    </>
  );
}
